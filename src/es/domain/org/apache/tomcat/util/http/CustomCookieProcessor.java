 ...
 */
package es.domain.org.apache.tomcat.util.http;
 ...
 * RFC2109 and RFC2616, modified to add SameSite=true on session cookies.
 *
 ...
 * @author kevin seguin
 */
public final class CustomCookieProcessor extends CookieProcessorBase {

    private static final Logger log = Logger.getLogger(CustomCookieProcessor.class.getName());
    ...
    public CustomCookieProcessor() {
        ...
        log.info("Construido el CookieProcessor a medida");
    }
        ...
        while (pos >= 0) {
            ...
            if (cookieValue != null && !cookieValue.isNull() ) {
                if (cookieValue.getType() != MessageBytes.T_BYTES ) {
                    ...
                    log.info("Cookies: Parsing cookie as String. Expected bytes: " + e);
                    cookieValue.toBytes();
                }
                log.info("Cookies: Parsing b[]: " + cookieValue.toString());
    ...
    public String generateHeader(Cookie cookie) {
        ...
        final boolean isSessionCookie = cookie.getName().toLowerCase().contains("jsessionid");

        // Secure
        if (cookie.getSecure() || isSessionCookie) {
          buf.append ("; Secure");
        }
    ...
    private final void processCookieHeader(byte bytes[], int off, int len,
        ...
        while (pos < end) {
            ...
            if (isSpecial) {
                ...
                log.info(sm.getString("cookies.invalidSpecial"));
            } 
            else { // Normal Cookie
